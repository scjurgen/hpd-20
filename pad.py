...
class Pad:
    ...
    def get_volume(self, instrument):
        return self.memoryBlock[VOL_INDEX+instrument]

    def get_pan(self, instrument):
        return self.memoryBlock[PAN_INDEX+instrument]

    def get_color(self, instrument):
        return self.memoryBlock[COLOR_INDEX+instrument]

    def get_sweep(self, instrument):
        return self.memoryBlock[SWEEP_INDEX+instrument]

    def get_muffling(self, instrument):
        return self.memoryBlock[MUFFLING_INDEX+instrument]

    def get_patch(self, instrument):
        return MemoryOp.get_unsigned_int16(self.memoryBlock, PATCH_INDEX + instrument * 2)

    def get_internal_patch(self, instrument):
        return MemoryOp.get_unsigned_int16(self.memoryBlock, PATCH_INTERNAL_INDEX + instrument * 2)

    def get_pitch(self, instrument):
        return MemoryOp.get_int16(self.memoryBlock, PITCH_INDEX+instrument*2)

    def get_midi(self):
        return self.memoryBlock[MIDI_INDEX]
